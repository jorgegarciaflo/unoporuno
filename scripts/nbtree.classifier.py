...
def main():
    ...
    for persona in busqueda.persona_set.all():
        ...
        nbtree_path = UNOPORUNO_ROOT + '/resources/classifiers/nbtree/NBTree.data.model'
        command = 'java weka.classifiers.trees.NBTree -l '+nbtree_path+' -T '+person_file+' -p 1 > '+person_file+'.out'
